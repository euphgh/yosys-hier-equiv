...
/usr/bin/time -v yosys-hier-equiv flatten-oracle \
  --gold /home/hgh/remuws/remu/examples/golden/picorv32/part0/emu_system.v \
  ...
  -I /home/hgh/remuws/remu/examples/build/picorv32/part0 \
  -I /home/hgh/remuws/remu/examples/golden/picorv32/part0 \
  --top EMU_SYSTEM_0 \
  --seq 2 \
  --work-dir build/picorv32-part0-flatten-oracle
